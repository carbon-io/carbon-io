...
* `Hello World <https://github.com/carbon-io-guides/example__hello-world-service/tree/carbon-0.6>`_ - A simple
  Hello World service.

* `Simple Command-line App
  <https://github.com/carbon-io-guides/example__simple-cmdline-app/tree/carbon-0.6>`_ - A simple
  command-line application.

* `Test Suites
  <https://github.com/carbon-io-guides/example__test-suites/tree/carbon-0.6>`_ - This example illustrates
  how to make test suites using ``test-tube``.

* `Parameter Parsing
  <https://github.com/carbon-io-guides/example__hello-world-service-parameter-parsing/tree/carbon-0.6>`_ - A
  Hello World service that illustrates the use of parameter and response definitions.

* `Microservice chaining
  <https://github.com/carbon-io-guides/example__hello-world-service-chaining/tree/carbon-0.6>`_ - A
...
* `API Key Authentication
  <https://github.com/carbon-io-guides/example__hello-world-service-aac/tree/carbon-0.6>`_ - A
...
* `MongoDB
  <https://github.com/carbon-io-guides/example__hello-world-service-mongodb/tree/carbon-0.6>`_ - A Hello World service.
...
* `Zipcode service <https://github.com/carbon-io-guides/example__zipcode-service/tree/carbon-0.6>`_ - A service for
  managing zipcodes. This example illustrates the use of
  ``MongoDBCollection``\s to create microservices.

* `Contacts API <https://github.com/carbon-io-guides/example__contact-service/tree/carbon-0.6>`_ - A service for
